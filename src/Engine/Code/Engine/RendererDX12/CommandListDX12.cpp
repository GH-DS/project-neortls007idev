...
CommandListDX12::CommandListDX12( RenderContextDX12* owner , CommandAllocatorDX12* commandAllocator , ID3D12PipelineState* pipelineState , D3D12_COMMAND_LIST_TYPE type ) :
																																		m_owner( owner )
{
	GUARANTEE_OR_DIE( owner->m_device->CreateCommandList( 0 , type , commandAllocator->m_commandAllocator , pipelineState , IID_PPV_ARGS( &m_commandList ) ) == S_OK ,
