...
Texture* SwapChain::GetBackBuffer()
{
	...
	// first, we request the D3D12 handle of the texture owned  by the swapbuffer
	ID3D12Texture2D* textureHandle = nullptr;
	m_handle->GetBuffer( 0 , __uuidof( ID3D12Texture2D ) , ( void** ) &textureHandle );
